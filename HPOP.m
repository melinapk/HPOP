...
global const Cnm Snm AuxParam eopdata swdata SOLdata DTCdata APdata PC Step_counter orbits time time_init v_previous
...
% model parameters
AuxParam = struct('Mjd_UTC',0,'area_solar',0,'area_drag',0,'mass',0,'Cr',0,'Cd',0,'n',0,'m',0,'sun',0,'moon',0,'sRad',0,'drag',0,'planets',0,'SolidEarthTides',0,'OceanTides',0,'Relativity',0,'Thrust',0);
